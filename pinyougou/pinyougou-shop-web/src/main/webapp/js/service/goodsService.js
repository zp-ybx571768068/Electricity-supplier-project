...
app.service("goodsService",function ($http) {
    ...
    this.isPutAway = function (selectedIds, marketable) {
        return $http.post("../goods/isPutAway.do?ids="+selectedIds+"&marketable="+marketable);
    };
    this.submitAudit = function (selectedIds, status) {
        return $http.get("../goods/submitAudit.do?ids=" + selectedIds + "&status=" + status);
    }
});